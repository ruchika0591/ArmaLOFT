...
public class Link4Fragment extends Fragment{

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_link4,container,false);
        ...
        TextView text10= (TextView)  view.findViewById(R.id.textView82);
