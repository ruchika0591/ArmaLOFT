...
public class DatabaseOpenHelper2 extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME="finalstandard.sqlite";
    ...
    public DatabaseOpenHelper2(Context context){
        ...
        public String getStandard(String name,Context context){
            ...
            try
            {
                ...
                sqLiteOpenHelper
                        = new DatabaseOpenHelper2(context);
                SQLiteDatabase db
                        = sqLiteOpenHelper
                        .getWritableDatabase();
            ...
            Cursor c = null;
            c=db.rawQuery("select Title from newStandard1 where Accn_no= '" + name + "'", new String[]{});
            while (c.moveToNext()) {
                ...
                {
                    Log.d("a", "getStandard: "+e.getMessage());
