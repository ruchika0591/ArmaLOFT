...
public class DatabaseOpenHelper3 extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME="ebook2.sqlite";
    private static final int DATABASE_VERSION=1;


    public DatabaseOpenHelper3(Context context){
        ...
        public String getebooks(String name, Context context){
            ...
            try
            {
                ...
                sqLiteOpenHelper
                        = new DatabaseOpenHelper3(context);
                SQLiteDatabase db
                        = sqLiteOpenHelper
                        .getWritableDatabase();
            ...
            Cursor c = null;
            c=db.rawQuery("select Title from eBooks2_eBooks where Title like '%" + name + "%'", new String[]{});
            while (c.moveToNext()) {
