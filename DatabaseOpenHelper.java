...
public class DatabaseOpenHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME="Glossary_On_Armament1.sqlite";
    ...
    public String getAddress(String name,Context context){
        ...
        try
        {
            ...
            c=db.rawQuery("select Address from Armasheet1 where name like '" +name+ "%'", new String[]{});
        ...
        {
            Log.d("a", "getAddress: "+e.getMessage());
        }
